    ...
    <body>
        ...
        <div class="container">
            ...
            <?php if($user): ?>
                ...
                $long_live_access_token = $facebook->getAccessToken();
                echo 'Hosszú távú access token:';
                echo '<br />';
                echo $long_live_access_token;
                echo '<br />';
                echo '<br />';
                ...
                // csiga access tokenje
                // AAAH1gGm2Pp8BAJx3FGZC4AFHSn3fZC5Cqeb6ZAKcLIwAujfFZCZCLfnhuXaa5DQmwmaDmlwgSMhSqqOlukOLpvQXe8HyjZCl65aaZCxrPEGgwZDZD

                $ret_obj = $facebook->api('/me/feed', 'POST',
                array(
                  'access_token' => 'AAAH1gGm2Pp8BAJx3FGZC4AFHSn3fZC5Cqeb6ZAKcLIwAujfFZCZCLfnhuXaa5DQmwmaDmlwgSMhSqqOlukOLpvQXe8HyjZCl65aaZCxrPEGgwZDZD',
                  'link' => 'http://test.hu',
